...
#if UNITY_EDITOR && UNITY_QNX

        private static bool IsQNX80X64()
        {
            var flags = System.Reflection.BindingFlags.Public |
                        System.Reflection.BindingFlags.Static |
                        System.Reflection.BindingFlags.FlattenHierarchy;
            var osVersion = typeof(UnityEditor.EditorUserBuildSettings).GetProperty("selectedQnxOsVersion", flags);
            var osArchitecture = typeof(UnityEditor.EditorUserBuildSettings).GetProperty("selectedQnxArchitecture", flags);

            if (null == osVersion || null == osArchitecture)
            {
                return false;
            }
            int osVersionValue = (int)osVersion.GetValue(null, null);
            string osArchitectureValue = osArchitecture.GetValue(null, null).ToString();
            //enum UnityEditor.QNXOsVersion.Neutrino80 is 2
            return osVersionValue == 2 && osArchitectureValue == "X64";
        }
#endif
#if !UNITY_DOTSPLAYER
        /// <summary>
...
//In OpenHarmony platform,it's not support yet
#if UNITY_EDITOR && UNITY_OPENHARMONY
            ForceDisableBurstCompilation = true;
#endif
//Platform QNX8 X64 unsupport burst. See HMIPF-1130
#if UNITY_EDITOR && UNITY_QNX
            ForceDisableBurstCompilation = IsQNX80X64();
#endif
        }
